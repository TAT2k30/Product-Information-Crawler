...
function Footer({ currentBodyLightMode, currentTextLightMode, currentShadowLightMode }: FooterProps) {
  return (
    <footer className={`${currentBodyLightMode} ${currentTextLightMode} py-10 mt-auto transition-all duration-500 shadow-lg`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-500">
              We are committed to delivering quality products and services worldwide. Discover more about our mission and values.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-500">
              ...
              <li><a href="#" className="hover:text-gray-800 transition-colors duration-300">Services</a></li>
              <li><a href="#" className="hover:text-gray-800 transition-colors duration-300">About Us</a></li>
              <li><a href="#" className="hover:text-gray-800 transition-colors duration-300">Contact</a></li>
            </ul>
          </div>
